...
const RichTextSetting: FC<textState> = ({
  textValue,
  textStyles = {},
  onChangeValue,
  onChangeStyles,
  ...
  const handleChangeStyle = (
    type: "fontWeight" | "fontStyle" | "textShadow",
    val: string,
  ) => {
    let styleVal = "";
    switch (type) {
      ...
      <Form.Item label="字体">
        <Select
          ...
          onChange={(value: string) =>
            onChangeStyles?.({ ...textStyles, fontFamily: value })
          }
        >
          {[
            "黑体",
        ...
        <Space size={6}>
          <ColorPicker
            onChange={(_, hex: string) =>
              onChangeStyles?.({ ...textStyles, color: hex })
            }
          >
            <Button
              icon={<SvgIcon name="color-font" size={20} />}
              style={{ color: textStyles.color }}
            />
          </ColorPicker>
          <ColorPicker
            onChange={(_, hex: string) =>
              onChangeStyles?.({ ...textStyles, backgroundColor: hex })
            }
          >
            <Button
              icon={<SvgIcon name="color-bg" size={20} />}
              style={{ color: textStyles.backgroundColor }}
            />
          </ColorPicker>
          <Button
            ...
            onClick={() =>
              handleChangeStyle("fontWeight", textStyles.fontWeight!)
            }
          />
          <Button
            ...
            onClick={() =>
              handleChangeStyle("fontStyle", textStyles.fontStyle!)
            }
          />
          <Button
            ...
            onClick={() =>
              handleChangeStyle("textShadow", textStyles.textShadow!)
            }
          />
          <Dropdown
            menu={{
              items: alignItems,
              selectedKeys: [textStyles.textAlign!],
